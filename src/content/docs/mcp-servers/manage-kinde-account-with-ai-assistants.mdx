...
title: Manage Kinde account with AI assistants
description: "Set up the Kinde Management MCP server with AI assistants like Cursor, Claude Desktop, Claude CLI, and VS Code to manage users, organizations, roles, and permissions from your IDE using natural language"
sidebar:
  order: 3
tableOfContents:
  maxHeadingLevel: 3
...
- An AI assistant that supports MCP protocol (e.g., [Claude Desktop](https://claude.com/download) or [Claude CLI](https://code.claude.com/docs/en/overview))
