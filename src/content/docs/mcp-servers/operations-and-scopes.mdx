...
title: Operations and Scopes for Kinde MCP server
description: "Complete reference guide to all operations and scopes available in the Kinde Management MCP server including user management, organizations, roles, permissions, and configuration operations"
sidebar:
  order: 4
relatedArticles:
...
You can ask your AI agent "What tools do you have available from Kinde?" to see the available operations and scopes.

## Next steps

See [Manage Kinde account with AI agents](/mcp-servers/manage-kinde-account-with-ai-agents/) to set up the Management MCP server.