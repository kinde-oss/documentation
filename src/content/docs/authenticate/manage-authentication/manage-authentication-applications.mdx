...
You first need to [set up all your auth methods](https://kinde.com/docs/authentication-and-access/set-up-user-authentication/) and [set up each application](/build/applications/add-and-manage-applications/).
...
5. If there is a method that you want that is not listed, [set it up](https://kinde.com/docs/authentication-and-access/set-up-user-authentication/).
