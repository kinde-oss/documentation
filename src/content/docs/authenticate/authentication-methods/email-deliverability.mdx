...
You’ll want to configure this before your production environment goes live. Add your SMTP details under **Settings > Environment > Messaging > Email Sender**. See [Customize email sender](/get-started/connect/customize-email-sender/).
