...
Use [Kinde’s management API](https://kinde.com/api/docs/#kinde-management-api-connections) to manage social and enterprise connections. You can view a list of connections, add a new connection, identify a connection, and update existing connections.
