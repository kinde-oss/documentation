...
After saving, Kinde sends OTP and MFA codes through WhatsApp when available, and falls back to SMS if delivery fails.
...
### How much does Kinde charge for WhatsApp message delivery?

Kinde does not charge for WhatsApp message delivery. Meta charges for WhatsApp Business messaging based on [Meta pricing](https://developers.facebook.com/docs/whatsapp/pricing).
