...
When you set up a [Microsoft Azure AD](/authenticate/enterprise-connections/azure/) or [custom SAML](https://kinde.com/docs/authentication-and-access/custom-saml/) connection, you’ll configure the home realm (or domains) to be recognized during authentication. All home realm domains must be unique across all connections in the environment.
...
- Email addresses ending with `@enterpriseB.com` use AzureAD connection B
