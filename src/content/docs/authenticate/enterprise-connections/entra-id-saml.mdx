...
deprecated: false
ai-summary: >
  Advanced guide to Microsoft Entra ID SAML enterprise authentication setup including application configuration, group synchronization, and federation metadata.
---
