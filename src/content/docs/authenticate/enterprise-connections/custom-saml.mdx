...
8. If your identity provider is Microsoft Azure, add `spn:` to the beginning of the Entity ID string in Kinde, e.g. `spn:5836g209gbhw09r8y0913`.
...
13. Select whether you want to automatically **Create a user record in Kinde** for new users. This can save time adding them manually or via API later.
