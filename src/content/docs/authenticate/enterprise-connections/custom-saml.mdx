...
7. Select the **Sign request algorithm** and **Protocal binding**. The options you choose will depend on what your identity provider prefers or requires.
...
9. (Optional) Add a first name and last name attribute.
