...
Note that this feature has nothing to do with security or access control and everything to do with routing. Do not confuse this feature with access restrictions for [domain allowlists](new topic).
