...
4. Paste in the **Callback URL** (the one you copied above), e.g. `https://yourdomain.kinde.com/login/callback`.
5. Save your changes.
...
4. Select which applications will allow Discord social sign in.
5. Select **Save**.
