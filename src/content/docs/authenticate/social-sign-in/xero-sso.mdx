...
3. In the window that appears, select **Xero,** then select **Save**. **Xero** now appears in the **Social connections** list.
...
4. Select which applications will allow Xero social sign in.
5. Select **Save**.
