...
You can enable users to sign up and sign in using their Clever credentials. To enable this, follow all the steps below to create a Clever app and configure credentials in Kinde.
    ...
    <img src="https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/05da14a9-4ac3-42dd-f930-55c81f080800/public" alt="clever sso card in Kinde" width="50%" />
...
5. Select **Continue with Clever** and sign in with the test Teacher credential
    ...
    <img src="https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/11037ee9-d88f-4a66-3d69-ad315c802e00/public" alt="continue with clever button" width="50%" />
