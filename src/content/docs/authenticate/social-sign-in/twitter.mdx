---
page_id: 2d5ddede-b5be-4c05-ae82-300e0c2201e3
...
> ℹ️ You may notice X still has mixed URLs and messaging for the name change from Twitter on their own site. We refer to X in this document.
...
3. In the window that appears, select **X**, then select **Save**. X now appears in the list of **Social connections**.
4. On the **X** tile, select **Configure**.
...
7. Enter the Kinde callback URL you copied earlier.
...
5. Select which applications will allow users to sign in with X.
6. Select **Save**.
