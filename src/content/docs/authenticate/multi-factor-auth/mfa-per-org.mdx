...
8. Use the **Enable recovery codes** toggle to control whether users in this organization see recovery codes during MFA setup. This overrides the environment-level recovery codes setting. If disabled, users in this organization will skip the recovery code step when setting up MFA.
9. Select **Save**. 
