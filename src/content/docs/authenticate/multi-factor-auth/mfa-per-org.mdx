...
- If you want MFA to be applied in only some organizations or for some connections in your business, set this to 'No'. You will then need to set MFA in each organization separately.
