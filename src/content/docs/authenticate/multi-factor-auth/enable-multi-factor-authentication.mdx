...
When you set up MFA using this procedure, it will apply to all users in your business. If you want, you can [enforce MFA for individual organizations](/authenticate/multi-factor-auth/mfa-per-org), so it only affects users in that organization.
