...
- **SMS** - users receive a one-time-password (OTP) via SMS.
  ...
  > ⚠️ Requires additional setup, see [Set up phone or SMS authentication](/authenticate/authentication-methods/phone-authentication/).
...
When you set up MFA using this procedure, it will apply to all users in your business.
...
4. Select the additional authentication options that you want to be available to your users. Such as an authenticator app, email, or SMS.
   ...
   > ⚠️ SMS requires additional setup, see [Set up phone or SMS authentication](/authenticate/authentication-methods/phone-authentication/).
