...
- **SMS** - users receive a one-time-password (OTP) via SMS ([this factor requires a Twilio account and additional setup](/authenticate/authentication-methods/phone-authentication/))
