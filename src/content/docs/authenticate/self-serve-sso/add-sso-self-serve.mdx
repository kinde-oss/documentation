...
- **Sign-in button** - Controls when the SSO button for this connection appears on the sign-in screen. Connections created through the self-serve portal default to **Auto**, which shows the button unless the connection has home realm domains set. Choose **Show** to always display the button, or **Hide** to never display it. See [Show or hide the SSO sign-in button](/authenticate/enterprise-connections/about-enterprise-connections/#show-or-hide-the-sso-sign-in-button-on-the-auth-page).
