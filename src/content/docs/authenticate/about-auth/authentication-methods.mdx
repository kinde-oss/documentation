...
featured: false
deprecated: false
ai_summary: "Complete guide to Kinde authentication methods including email password, passwordless OTP, phone SMS, social providers, and enterprise SSO. Notes that a one-time passcode can be offered on the password screen without enabling both email connections, and links to the dedicated guide for using password and passwordless auth at the same time. Intended for developers and product managers choosing how users sign in."
topics:
  - authenticate
sdk: []
languages: []
...
To offer a one-time passcode on the same password screen, without enabling both email connections, see [Use password and passwordless auth at the same time](/authenticate/authentication-methods/use-password-and-passwordless-auth/).
