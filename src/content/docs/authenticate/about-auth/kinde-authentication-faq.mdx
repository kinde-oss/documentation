...
Kinde handles password authentication on their hosted pages for security reasons—passwords are stored as hash-encrypted strings and are never exposed to your application or even visible to Kinde administrators.
