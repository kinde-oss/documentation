...
- with a [phone number](https://kinde.com/docs/authentication-and-access/phone-authentication/) ([Beta feature](https://kinde-21631392.hs-sites.com/en-au/beta-feature-interest))
- with a range of [social sign in options](/authenticate/social-sign-in/add-social-sign-in/), like Google, Apple, Slack, and more
- via enterprise auth such as [Microsoft Azure AD](/authenticate/enterprise-connections/azure/) and [SAML](https://kinde.com/docs/authentication-and-access/custom-saml/#custom-authentication-with-saml)
...
1. [Set up user authentication](https://kinde.com/docs/authentication-and-access/set-up-user-authentication/)
2. [Add social sign in](/authenticate/social-sign-in/add-social-sign-in/)
3. [Enable multi-factor authentication](https://kinde.com/docs/authentication-and-access/enable-multi-factor-authentication/)
