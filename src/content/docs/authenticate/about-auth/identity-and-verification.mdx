...
When you set up an enterprise connection or a social connection, you can select the option to trust them. For example, go to **Settings > Authentication > Social connections** and select **Configure** on a tile. You'll see the **Trust email addresses provided by this connection** switch. Switch on or off as you like.
