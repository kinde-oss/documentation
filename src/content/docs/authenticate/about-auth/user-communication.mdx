...
Kinde supports [phone authentication](https://kinde.com/docs/authentication-and-access/phone-authentication/) as a primary and secondary authentication factor.
