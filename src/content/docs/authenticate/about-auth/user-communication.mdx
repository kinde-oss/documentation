...
Core authentication emails (verification, OTP, password reset) cannot be fully disabled. You can customize the sender and content, but Kinde will still send these emails when the relevant auth flows run.
