...
Kinde supports password-based, passwordless (email OTP), phone authentication, social sign-in (Google, Apple, GitHub, etc.), and enterprise connections via SAML. You can mix and match these methods based on your application needs.
