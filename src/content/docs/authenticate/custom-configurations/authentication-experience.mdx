...
## Same page sign-up / registration (seamless sign up)

If you want users to be able to sign up and sign in on a single page, update your app to redirect all authentication through the registration flow. The result of doing this is:
