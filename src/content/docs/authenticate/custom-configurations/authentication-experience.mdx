...
![Authentication experience options in Kinde](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/3ac2e291-2563-47de-ea5c-9dbe03b87300/public)
...
## Show /hide sign in and sign up link options on auth pages

Depending how you want to onboard users to your application, you can present several options on your auth pages. 

- Show / hide a link to the sign up page from the sign in page
- Show / hide a link to the sign in page from the sign up page
