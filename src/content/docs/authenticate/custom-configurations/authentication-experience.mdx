...
2. Go to **Settings > Applications > View details** on your application.
3. Scroll to the **Authentication experience** section.
4. Switch on the **Authenticate users via a same page experience** option.
