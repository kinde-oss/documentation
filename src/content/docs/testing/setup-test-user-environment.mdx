...
If you are creating your tests from scratch, you can use the [Kinde Next.js end-to-end test application](https://github.com/tamalchowdhury/kinde-test-application) to get started.
