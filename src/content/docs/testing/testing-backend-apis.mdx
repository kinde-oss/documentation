...
You can add your API to Kinde. This will scope your token to be used only for your testing setup. This is optional, but it is a good practice to do so. Learn more about [registering and managing APIs in Kinde](/developer-tools/your-apis/register-manage-apis/).
