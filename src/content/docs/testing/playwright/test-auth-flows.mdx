...
Kinde requires OTP email verification when signing up for a new user. See the [Testing Passwordless Flows](/developer-tools/testing/playwright/test-passwordless-flows/) guide for details on how to handle OTP verification in your test methods.
...
Check out the full working example in the [Testing Passwordless Flows](/developer-tools/testing/playwright/test-passwordless-flows/) guide.
...
If your application uses passwordless authentication with email OTP, see the dedicated guide on **[Testing Passwordless Flows](/developer-tools/testing/playwright/test-passwordless-flows/)**.
