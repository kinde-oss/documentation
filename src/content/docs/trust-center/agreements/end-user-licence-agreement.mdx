...
2. **Introduction**
   ...
   2. We provide a cloud-based, software as a service platform where we help our customers with user management, feature management, experimentation and other back-office features for running and managing their businesses (**Platform**).
