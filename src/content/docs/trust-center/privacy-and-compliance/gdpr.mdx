...
The GDPR establishes the right for data subjects to receive their personal data in a structured, commonly used, machine-readable format.

</Aside>

Kinde supports data portability through our [data export feature](/manage-your-account/your-data/exporting-data/). Business owners can export all user data, organizations, and access requests in NDJSON format. This ensures you have complete data portability, including everyone who has shown interest in your product—not just those who've completed registration.
