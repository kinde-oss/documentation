...
External users are users of Kinde’s customers.
...
Email services: If you have setup a custom SMTP provider in your Kinde admin, then AWS for email services will not be sub-processor since we're sending via your own SMTP provider.
