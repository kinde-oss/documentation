...
1. Get the access token using the [relevant SDK](/developer-tools/about/our-sdks/) or manually if you are [using Kinde without an SDK](/build/about/using-kinde-without-an-sdk/).
