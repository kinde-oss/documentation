...
If you want to build a self-serve profile manager for your users, this is one way to do it. Kinde also comes with a default [self-serve portal for users] that you can embed in your app.
