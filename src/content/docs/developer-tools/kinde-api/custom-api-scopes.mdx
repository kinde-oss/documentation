...
You need to have [registered your APIs](/developer-tools/kinde-api/register-an-api/#register-and-manage-apis) in Kinde to secure them using scopes.
...
> ⚠️ Take care deleting scopes. If a scope is in use, it can cause breaking changes for users and applications that are dependent on them.
