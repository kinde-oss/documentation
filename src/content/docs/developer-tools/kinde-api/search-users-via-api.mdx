...
- Filter users based on last activity date using the `active_since` parameter. This filters users by their last login date, useful for identifying inactive accounts or targeting recently active users.
