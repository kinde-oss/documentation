...
title: Test access token requests for the Kinde API
sidebar:
  order: 2
relatedArticles:
...
To securely connect to Kinde’s API, you need to obtain an access token. Once you have completed the [connection steps](/developer-tools/kinde-api/get-access-token-for-connecting-securely-to-kindes-api/), you're ready to make an access token request.
