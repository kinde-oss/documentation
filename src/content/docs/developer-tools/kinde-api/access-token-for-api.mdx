...
If you decide to use Postman, we recommended that you set up a Postman environment. Here's some [troubleshooting solutions](/developer-tools/kinde-api/test-the-connection-to-kindes-api/) in case you need them.
