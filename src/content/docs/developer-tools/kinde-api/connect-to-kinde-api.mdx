...
Here's the process for setting up your access to the Kinde Management API.
...
We recommend adding as few scopes as you need, to maintain API security. Learn more about [scopes](/developer-tools/kinde-api/about-m2m-scopes/).
...
Follow this [guide for accessing Kinde Mangement API token](/developer-tools/kinde-api/access-token-for-api/). The guide includes steps for how to obtain and use a token, how to test endpoints, and examples using Postman and NodeJS.
