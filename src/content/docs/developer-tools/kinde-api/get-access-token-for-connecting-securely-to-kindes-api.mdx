...
5. Copy the app keys. You need these details to test or initiate access requests from your application or service to Kinde's API. See [below](/developer-tools/kinde-api/get-access-token-for-connecting-securely-to-kindes-api/#Step-3:-get-an-access-token).
...
## Step 3: Test the access token request

- Get access token using Postman
- Test endpoints using Postman
- Call the Kinde API Node.js (example)
