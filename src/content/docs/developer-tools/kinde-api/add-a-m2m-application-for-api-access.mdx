...
2. Select the three dots menu next to the Kinde management API, then choose Authorize application.
3. Select the three dots menu next to the Kinde management API, then choose Manage scopes. 
4. For maximum security only enable the minimum scopes you require. Select **Save**
5. Next: [Get an access token for Kinde’s management API](/developer-tools/kinde-api/get-access-token-for-connecting-securely-to-kindes-api/).
