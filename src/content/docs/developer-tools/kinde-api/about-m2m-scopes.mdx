...
title: About scopes in Kinde Management API
description: "Comprehensive guide to M2M scopes for Kinde Management API, including scope examples and management procedures"
sidebar:
  order: 8
  label: "About scopes"
relatedArticles:
