...
## Sign up flow with Playwright and Mailosaur
...
9. Create a new test file with the command: `touch tests/email-password-signup.spec.ts` and add the following content:

### Option 1: Test sign up flow with email and password
...
### Option 2: Test sign up with passwordless flow

To use this method, go to your **Application** > **Authentication** > **Passwordless connections** > check the **Email + code** option and uncheck the **Email + password** option. Select **Save**. This is the default setting for new applications in Kinde.
