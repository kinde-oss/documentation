...
This guide covers practical approaches for automating passwordless authentication testing, from using dedicated test email services like Mailosaur and Mailtrap to building custom email-to-storage pipelines. You'll learn how to capture OTP emails, extract verification codes, and integrate these steps into your end-to-end test suites.
...
4. Run the following command in your terminal to setup a Mailosaur project:

    ```bash
    npm create mailosaur@latest
    ``` 
5. Enter the following answer for the questions:
    - What is your project named? › **mailosaur-tests**
    - Select your testing framework › **Playwright**
    - Select a language › **Node.js**
    - Do you want to create example tests? › **No**

    This will scaffold a new Mailosaur project.
...
6. Install the dependencies:
    ...
    npm install
    ```
7. Install TypeScript types for Node:
    ```bash
    npm install --save-dev @types/node
    ```
8. Add the following to your `.env` file and save it:
    ```env
...
9. Create new test file(s), (e.g., `touch tests/passwordless-signup.spec.ts`) and add the following content:
...
1. Use the following command to run the tests in UI mode:
    ...
    ![user can sign up with email and code](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/cc2e6271-5250-4f54-5366-7135ec2dd800/public)

2. Go to your Kinde dashboard > **Users** to find the test users you created.

    ![Test users in Kinde dashboard](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/f2f25a56-d209-40ec-9bce-86932777d700/public)


## Download the example project

- [Kinde E2E Passwordless example project](https://github.com/tamalchowdhury/kinde-e2e-passwordless-example)
