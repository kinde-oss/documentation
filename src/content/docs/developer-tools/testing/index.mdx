...
- **Authentication flow testing**: Test sign-up, sign-in, and sign-out flows using browser automation tools
- **Authenticated feature testing**: Test protected routes and features after authentication using saved session state

Each approach has its own guide with detailed implementation steps and examples.
...
**[Setup test user and environment](/developer-tools/testing/setup-test-user-environment/)** - Create test users, configure test applications, and set up isolated test environments. This setup is required for all testing methods.
