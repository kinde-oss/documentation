...
When testing backend APIs, it is recommended to add your API to Kinde. Here's how to do it:
...
### Sample integration with test application (Next.js)

1. Login to your test application and get the `refresh_token` cookie value. 
    
    Learn how to [obtain the refresh token](/developer-tools/testing/backend-api-testing/#step-2-obtain-initial-tokens) here.
