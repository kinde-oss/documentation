...
title: WIP Testing authentication flows
...
2. **Use a verified test user**: Use a test user with a verified email address to skip verification flows (created during setup).

3. **Use a test application**: Use the dedicated test application configured during setup.
