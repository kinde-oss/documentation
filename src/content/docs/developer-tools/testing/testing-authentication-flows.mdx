...
2. **Handle email verification**: Use an email testing service to test user sign up (see [Testing Passwordless Flows](/developer-tools/testing/testing-passwordless-flows/))
