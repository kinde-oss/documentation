...
- [NextJS App Router SDK](/developer-tools/sdks/backend/nextjs-sdk/)
- [NextJS Pages Router SDK](/developer-tools/sdks/backend/nextjs-prev-sdk/)
...
Contact us via [Slack](https://join.slack.com/t/thekindecommunity/shared_invite/zt-26hdaavyc-CfOa06vP23guSwK~~OpFMQ) or [Discord](https://discord.gg/KdkCXRNTFn) support channels if you want to contribute a community SDK.
