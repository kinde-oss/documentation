...
featured: false
deprecated: false
ai-summary: Complete guide for iOS SDK including CocoaPods installation, multiple environment configuration, custom logging, and native iOS authentication integration.
---
