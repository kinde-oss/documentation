...
You can pass optional parameters to sign users up for a billing plan or subscription:
...
sdk.createOrg(
  orgName: "org_1234",
  planInterest: "enterprise_annual", // optional - for billing plans
  pricingTableKey: "enterprise_2024" // optional - for billing plans
);
```
