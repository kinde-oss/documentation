...
```tsx
import { kindeAuthHandler } from "@kinde/kinde-auth-tanstack-start/server";Collapse commentComment on line R67DanielRivers commented on Nov 9, 2025 DanielRiverson Nov 9, 2025MemberMore actionsThis will be @kinde/tsrI thinkReactWrite a replyResolve comment
