...
description: "Install and configure the Kinde SDK for TanStack Start: environment variables, auth routes, route protection, and client hooks."
sidebar:
  order: 10
tableOfContents:
  maxHeadingLevel: 3
...
featured: false
deprecated: false
ai_summary: Install and configure the Kinde SDK for TanStack Start with auth handlers, KindeTanstackProvider, useKindeAuth, server loaders, and protect utilities.
---
...
Re-exported from `@kinde-oss/kinde-auth-react/components`. Sends the user to the Kinde self-serve portal. Learn more about the [self-serve portal for users](/build/self-service-portal/self-serve-portal-for-users/).
...
- [React SDK documentation](/developer-tools/sdks/frontend/react-sdk/)
- [SDK issues on GitHub](https://github.com/kinde-oss/kinde-tsr/issues)
