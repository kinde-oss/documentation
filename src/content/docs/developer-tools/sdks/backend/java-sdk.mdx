...
featured: false
deprecated: false
ai-summary: Complete guide for Java SDK including Maven/Gradle installation, M2M token retrieval, PKCE authentication, and environment configuration for Java 17+ applications.
---
