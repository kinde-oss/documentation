...
featured: false
deprecated: true
ai-summary: Legacy guide for Next.js Pages Router SDK v1 including authentication setup, API endpoints, and provider configuration for older Next.js versions.
---
