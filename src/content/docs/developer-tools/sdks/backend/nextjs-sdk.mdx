...
5. Set the callback URLs for your application.
...
3. Create an environment variable file:
    ...
    ```
4. Copy the enviorment variables from the **Quick start** page to the `.env.local` file and save changes.
...
1. Install the Kinde dependency with the following command:
...
3. Open the newly created `route.ts` file, enter the following code, and save the file:
    ...
    ```
4. Copy the enviorment variables from the **Quick start** page to the `.env.local` or `.env` file and save changes.

5. Add the register and login links to your pages:
    ...
    ```
6. Protect your authenticated routes:
    ...
    ```
7. Display logged-in user info and logout link:
