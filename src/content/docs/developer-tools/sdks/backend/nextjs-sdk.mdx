...
6. Add the register and login links to your pages:
    ...
    ```
7. Protect your authenticated routes:
    ...
    ```
8. Display logged-in user info and logout link:
...
9. Start the development server:
    ...
    npm run dev
    ```
10. Open the browser and navigate to http://localhost:3000 to see the application.
11. Sign-up for a new user.
