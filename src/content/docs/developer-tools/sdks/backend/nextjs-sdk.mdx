...
- [Node.js](https://nodejs.org) version 20 or up
...
4. Create an environment variable file:
    ...
    ```
5. Copy the enviorment variables from the **Quick start** page to the `.env.local` file and save changes.
...
5. Copy the enviorment variables from the **Quick start** page to the `.env.local` or `.env` file and save changes. 
