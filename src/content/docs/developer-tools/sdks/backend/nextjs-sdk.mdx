...
Here is a full list of environment variables you can use:

| Variable                         | Description                                                                                                               | Example value                            |
| -------------------------------- | ------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------- |
| `KINDE_CLIENT_ID`                | Your business’s unique ID on Kinde                                                                                        | `your_kinde_client_id`                   |
| `KINDE_CLIENT_SECRET`            | Your business’s secret key (do not share)                                                                                 | `your_kinde_client_secret`               |
| `KINDE_ISSUER_URL`               | Your Kinde domain                                                                                                         | `https://your-kinde-subdomain.kinde.com` |
| `KINDE_SITE_URL`                 | Where your app is running                                                                                                 | `http://localhost:3000`                  |
| `KINDE_POST_LOGOUT_REDIRECT_URL` | Where you want users to be redirected to after logging out. Make sure this URL is under your allowed logout redirect URLs | `http://localhost:3000`                  |
| `KINDE_POST_LOGIN_REDIRECT_URL`  | Where you want users to be redirected to after authenticating                                                             | `http://localhost:3000/dashboard`        |
| `KINDE_AUDIENCE`                 | Optional - a whitespace separated list of audiences to populate the `aud` claim in the token                              | `your-audience`                          |
| `KINDE_SCOPE`                    | Optional - a whitespace separated list of scopes to request from Kinde                                                    | `openid profile email offline phone`     |
| `KINDE_DEBUG_MODE`               | Optional - set to `true` to enable debug mode                                                                             | `true`                                   |
| `KINDE_COOKIE_DOMAIN`            | Optional - the domain to set the cookie on                                                                                | `.your-domain.com`                       |
...
1. Enable the **Kinde Management API** for your Next.js app.
