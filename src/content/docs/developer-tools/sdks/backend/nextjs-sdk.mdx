...
This SDK is for Next.js version 13+ and uses Server Side Components and App Router. See [Version compatibility](#version-compatibility)
...
![nextjs sdk](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/7d96b537-48c1-4ff6-0a02-4502e963d200/socialsharingimage)
...
<a href="/api/auth/clear-session">Clear session</a>
```

<Aside type="warning">

Clearing cookies manually ends the local session but does not sign the user out of Kinde's authorization server. To fully sign a user out — including ending the Kinde session — use the standard [logout flow](/developer-tools/sdks/backend/nextjs-sdk/#log-out) instead. Use cookie clearing only as a debugging tool or last resort.
