...
- [Integrate with ASP.NET via APIs](/developer-tools/your-apis/dotnet-based-apis/)
...
```
Note this requires the `create:organizations` and `updated:organizations` scopes to be added to the API in the machine to machine application in Kinde.
