...
The sections below relate to how to call the Kinde Management API. You need to [add a machine to machine application](/developer-tools/kinde-api/about-m2m-scopes/) and [get an access token to connect](/developer-tools/kinde-api/connect-to-kinde-api/):
