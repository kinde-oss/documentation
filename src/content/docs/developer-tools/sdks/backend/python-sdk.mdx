...
featured: false
deprecated: false
ai-summary: Complete guide for Python SDK including Flask and FastAPI integration, OAuth configuration, environment variables, and session management for Python 3.9+ applications.
---
...
KINDE_REDIRECT_URI=http://YOUR_HOST:5000/callback
KINDE_HOST=https://yourdomain.kinde.com
KINDE_AUDIENCE=
LOGOUT_REDIRECT_URL=http://YOUR_HOST:5000/api/auth/logout
