---
page_id: 0898d073-fd33-421c-980f-13325fadc84a
title: Python SDK v1
description: "Legacy guide for Python SDK v1 including authentication setup, OAuth flows, user permissions, and callback management for Python 3.8+ applications."
sidebar:
  order: -1
  hidden: true
relatedArticles:
...
featured: false
deprecated: true
ai-summary: Legacy guide for Python SDK v1 including authentication setup, OAuth flows, user permissions, and callback management for Python 3.8+ applications.
---
