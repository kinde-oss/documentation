...
featured: false
deprecated: true
ai_summary: Legacy guide for Python SDK v1 including authentication setup, OAuth flows, user permissions, and callback management for Python 3.8+ applications.
---
