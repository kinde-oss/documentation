---
page_id: 00b420d2-0a19-4d46-81ff-7acc62950ca1
title: Node/Apollo GraphQL
description: "Guide to securing Node.js Apollo GraphQL endpoints with Kinde authentication, including backend and React client integration."
sidebar:
  order: 22
relatedArticles:
...
head:
  - tag: meta
    attrs:
      property: "og:image"
      content: "https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/99fc1094-6b9b-431c-dc61-d5ac6eedd000/socialsharingimage"
topics:
  - developer-tools
  - sdks
  - apollo
...
featured: false
deprecated: false
ai-summary: Guide to securing Node.js Apollo GraphQL endpoints with Kinde authentication, including backend and React client integration.
---
