...
description: "Quick guide to generating M2M test tokens in Kinde for API testing without using external tools"
sidebar:
  order: 2
relatedArticles:
...
featured: false
deprecated: false
ai-summary: Quick guide to generating M2M test tokens in Kinde for API testing without using external tools
---
