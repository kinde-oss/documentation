---
page_id: 38694042-311b-4b01-bce3-5bcd6282b167
title: Manage API scopes for M2M applications
sidebar:
  order: 4
relatedArticles:
...
You need to [register your API](https://docs.kinde.com/developer-tools/kinde-api/register-an-api/#register-and-manage-apis) and [secure your API](https://docs.kinde.com/developer-tools/kinde-api/custom-api-scopes/) before you can do this.
