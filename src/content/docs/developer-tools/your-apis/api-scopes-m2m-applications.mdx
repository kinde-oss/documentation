...
You need to [register your API](/developer-tools/kinde-api/register-an-api/#register-and-manage-apis) and [secure your API](/developer-tools/kinde-api/custom-api-scopes/) before you can do this.
