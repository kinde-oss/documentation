...
description: "Guide to managing API scopes for users through roles, additional scopes, and permissions claims"
sidebar:
  order: 8
relatedArticles:
...
featured: false
deprecated: false
ai_summary: Guide to managing API scopes for users through roles, additional scopes, and permissions claims
---
