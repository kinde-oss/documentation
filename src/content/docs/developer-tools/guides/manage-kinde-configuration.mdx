...
If you prefer to manage Kinde with Terraform, there are two options. You can combine them: use the provider for the resources it supports, and the seed script for everything else.
