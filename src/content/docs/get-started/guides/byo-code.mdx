...
Make Kinde your own by:

- Change login page branding
- Import or migrate users 
- Change auth strategies
- Add social or enterprise connections
- Add custom domain & email sender

Check out the [Customize your setup](/get-started/guides/set-up-tasks/).