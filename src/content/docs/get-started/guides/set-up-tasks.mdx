...
- [Create a form](/design/forms/set-up-subscription-form/) to collect emails from mailing list subscribers
...
- Add [Azure AD](/authenticate/enterprise-connections/azure/) or [SAML](/authenticate/enterprise-connections/custom-saml/) enterprise authentication (if you have enterprise customers)
