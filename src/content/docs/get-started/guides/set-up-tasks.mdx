...
<Aside type="upgrade">
You will need a [Kinde paid plan](https://kinde.com/pricing/) to remove the Kinde branding.
</Aside>
...
<Aside type="upgrade">
You will need a [Kinde paid plan](https://kinde.com/pricing/) to add third-party analytics and tracking.
</Aside>
