...
Add Kinde auth to your codebase and learn about these developer topics:

- Test user registration
- Set up test environments
- Use the Kinde Management API to automate admin tasks
- Run end-to-end tests
- Deploy your app to production

Check out the [Add Kinde to your codebase](/get-started/guides/byo-code/).