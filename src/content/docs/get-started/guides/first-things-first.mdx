...
Check out the [website](https://kinde.com/product-demo/), the [docs](https://kinde.com/docs/), the [blog](https://kinde.com/blog/), [videos](https://www.youtube.com/@heykinde), and hit up the [Slack community](https://join.slack.com/t/thekindecommunity/shared_invite/zt-1vyq8qilj-jFH5V27jfFnHk~BuBSU0ZA) to talk to other Kinde users.
