...
- **Use Kinde with my existing code base**
    ...
    ![kinde onboarding project options](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/e1015c6d-24c2-493b-5dc3-ed33f6315b00/socialsharingimage)
...
1. When you reach the **Almost there…** screen, select **No thanks, I’ll explore at my own pace.**
    ...
    ![kinde onboarding almost there screen](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/8f60950a-41e9-4434-2941-1da3648e8b00/socialsharingimage)
...
1. Enter the relevant URL(s) for your policies. You can add the **Terms of use URL**, the **Privacy policy URL**, or both.
...
2. Select **Save**.
    ...
    Learn more about [adding policies and terms](/manage-your-account/business-information/policies-terms/).
