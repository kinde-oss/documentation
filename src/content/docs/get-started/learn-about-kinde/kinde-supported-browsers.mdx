---
page_id: 0d072813-aff6-4e0d-8f33-c368f1208fc6
...
description: Information about Kinde's supported browsers including desktop and mobile browsers, Browserslist configuration, and browser compatibility requirements.
topics:
  - get-started
  - learn-about-kinde
sdk: []
...
featured: false
deprecated: false
ai-summary: Information about Kinde's supported browsers including desktop and mobile browsers, Browserslist configuration, and browser compatibility requirements.
---
