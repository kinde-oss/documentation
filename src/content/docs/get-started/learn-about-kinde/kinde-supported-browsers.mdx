...
featured: false
deprecated: false
ai_summary: Information about Kinde's supported browsers including desktop and mobile browsers, Browserslist configuration, and browser compatibility requirements.
---
