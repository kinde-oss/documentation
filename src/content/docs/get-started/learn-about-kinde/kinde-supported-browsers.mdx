...
If you find any issues, please report them via email to [support@kinde.com](mailto:support@kinde.com), the support chat in the Kinde admin, or the #support channels in [Slack](https://join.slack.com/t/thekindecommunity/shared_invite/zt-26hdaavyc-CfOa06vP23guSwK~~OpFMQ) or [Discord](https://discord.gg/KdkCXRNTFn).
