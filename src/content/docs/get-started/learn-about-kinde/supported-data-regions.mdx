...
app_context:
  - m: team
  - m: manage_business
description: Information about Kinde's supported data regions for data storage, compliance requirements, and performance optimization recommendations.
topics:
  - get-started
  - learn-about-kinde
sdk: []
...
featured: false
deprecated: false
ai_summary: Information about Kinde's supported data regions for data storage, compliance requirements, and performance optimization recommendations.
---
