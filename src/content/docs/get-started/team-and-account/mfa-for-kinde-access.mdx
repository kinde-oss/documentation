...
- The MFA factors that you want your team to have available to them, e.g. email code, SMA code, Authenticator app.
- Whether you want MFA to be opt-in or required
