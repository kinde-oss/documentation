...
sidebar:
  order: 3
description: Guide to customizing email sender configuration in Kinde including SMTP setup, email provider integration, and troubleshooting common issues.
relatedArticles:
...
featured: false
deprecated: false
ai_summary: Guide to customizing email sender configuration in Kinde including SMTP setup, email provider integration, and troubleshooting common issues.
---
