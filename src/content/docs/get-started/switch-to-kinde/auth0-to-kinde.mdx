...
Here's an example of the an identity extracted from Auth0.
...
```js
{
  ...
  "Created At": "2022-11-29T09:24:17.907Z",
  "Updated At": "2022-11-29T09:24:17.907Z",
  "identities": [
    {
      "profileData": {
        "email": "joe@bloggs.com",
...
Social identities without an email can be imported, and are identified by the connection type. You can also import users with multiple identities, these will be listed under the user’s profile. 
