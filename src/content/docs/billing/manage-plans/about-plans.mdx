...
- **Mixed-interval pricing:** Each plan can have more than one fixed charge, billed at different intervals. Customers are charged at mixed intervals, such as `$100 / year + $3 / month`. See [Mixed-interval pricing](/billing/manage-plans/create-plans/#mixed-interval-pricing).
- **Annual pricing:** You can offer annual pricing on one fixed charge per plan, at a custom yearly price. For example, a platform fee of $10/month, or $100/year if paid annually (a $20 saving per year). See [Offer annual pricing](/billing/manage-plans/create-plans/#offer-annual-pricing).
