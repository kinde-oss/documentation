...
3. Under **Collect tax automatically**, choose an option.
    ...
    ![Collect tax in kinde plan setting](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/89124387-09c6-473f-06d7-2eb7ac797900/socialsharingimage)
...
| **Collect** | Always enable Stripe Tax for subscriptions to this plan |
| **Don’t collect** | Never enable Stripe Tax for subscriptions to this plan |
...
- **Disabled**: Users can subscribe without providing payment information and proceed directly to your application.
    ...
    ![Ask for credit card toggle](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/d0380c04-a3ab-4663-d83b-061a00a9dc00/socialsharingimage)
...
4. Select **Save draft** or **Publish** to apply your changes.
    ...
    ![Trial period settings](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/41cfe0e1-4d3c-4148-41de-7d3db0884300/socialsharingimage)
...
You can add more than one fixed charge per plan, each with a different interval (monthly, daily, and so on). See [Mixed-interval pricing](#mixed-interval-pricing) for details.
...
2. Choose **Day**, **Week**, **Month**, or **Year**. The default is **Month**.
    ...
    ![billing interval dropdown with offer as annual toggle](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/ac461fc4-88e8-4760-ba44-29191e28fa00/socialsharingimage)

      - The interval you select determines how often Stripe bills the customer for this fixed charge.
      - The **Offer as annual** toggle is only available for non-yearly intervals (**Day**, **Week**, **Month**). If you select **Year**, the **Offer as annual** toggle does not apply. Selecting **Year** already bills annually. See [Offer annual pricing](#offer-annual-pricing) below for details.

          ![yearly interval disables the offer as annual toggle](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/bd551d7b-254d-45e4-f3b5-fda44885de00/socialsharingimage)
...
5. Select **Save**.
    ...
    ![set annual pricing](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/50fd2c8f-e341-4bdd-088b-64db8504c100/socialsharingimage)

<Aside>

If you have multiple fixed charges on the plan, only **one** fixed charge can use **Offer as annual**. Other fixed charges on the same plan keep the billing interval you set for them (for example, monthly).
...
You can add more than one fixed charge on a plan with different intervals. For example, a license fee of $100/year, a platform fee of $10/month, and a support fee of $3/week. The combination is a **mixed-interval** plan. Each charge is billed and displayed with its own interval—for example `$100 AUD / year + $3 AUD / month`—instead of a single collapsed total.

<img src="https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/375708dd-72f4-41fd-5040-89454d58b400/socialsharingimage" fetchpriority="low" loading="lazy" decoding="async" alt="mixed-interval charges" width="500px" />
...
3. Review the standard total versus the annual total (including any monthly remainder for mixed plans).
    ...
    <img src="https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/7482263e-2e57-404b-898c-bfee57f0ce00/socialsharingimage" fetchpriority="low" loading="lazy" decoding="async" alt="annual pricing preview" width="300px" />
...
To create a free plan, add a fixed charge with a **Price** of `0`. Make sure there are no other charges on the plan.

The `0` price ensures the plan is added to Stripe and included on the pricing table as a free plan.
