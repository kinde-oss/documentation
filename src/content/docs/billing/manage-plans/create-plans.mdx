...
| Capture payment info for easier upgrades | Enable—collect card details upfront for seamless plan transitions | Disable—users can evaluate your product with no strings attached |
