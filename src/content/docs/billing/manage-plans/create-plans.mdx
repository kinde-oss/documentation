...
Once you’ve got a list of plans, their features, prices, and details, you’re ready to create them in Kinde.
...
3. If you already have plans, select **Add plan** under the group you want to add to. The **Add plan** window opens.
    ...
    ![Add plas window](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/92cf723a-f99c-465c-26cc-3f60c817b200/public)
    
    <Aside>
    
    All plans must belong to a plan group, even if it’s just the default group. When you create your first plan, it will be automatically created in a group, which you can then re-label and manage. 
...
10. If the item is separately chargeable, select a **Pricing model**. 
    ...
    ![Add feature window, tiered prices](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/80ea9a38-e6ac-479f-9697-f04e237d4d00/publicg)
