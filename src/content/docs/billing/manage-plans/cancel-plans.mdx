...
Customers can only do this if you have enabled plan management in the [self-serve portal](/build/set-up-options/self-serve-portal-for-orgs/) and the customer has a [billing role](/billing/get-started/add-billing-role/) that allows them to make changes. 
