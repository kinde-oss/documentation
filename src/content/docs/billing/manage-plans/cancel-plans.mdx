...
3. They follow the prompts to cancel. This information is synced to Stripe. Depending on the [billing policies](/billing/manage-plans/plan-upgrade-downgrade/) you have set, they might receive a bill for unpaid usage, or be credited for unused subscription days.
