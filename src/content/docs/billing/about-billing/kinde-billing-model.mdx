...
- Fixed charges (e.g. subscription fees) are billed in advance at the interval you choose; customers pay at the start of their billing period. You can also offer one fixed charge per plan as annual at a custom yearly price.
