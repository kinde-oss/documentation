...
app_context:
  - m: billing
  - s: faq
description: "Get answers on Kinde billing—Stripe setup, plans, trials, tax, metered usage, upgrades, and self-serve support"
featured: false
deprecated: false
topics:
  - billing
...
You can enable **Collect tax automatically** in **Settings > Environment > Billing** (off by default). When enabled, Kinde turns on Stripe Tax for new subscriptions. Individual plans can inherit that setting, always collect, or never collect via **Collect tax automatically** in plan settings.

Tax amounts and invoice presentation still come from Stripe Tax on your connected Stripe account. Configure tax registrations and related Stripe Tax options in the Stripe Dashboard for the regions where you sell. Until a customer has a billing country (for example on a trial before a card is added), tax may use your Stripe account’s registered address.

**Learn more:** [About billing](/billing/about-billing/about-billing/#how-is-sales-tax-or-vat-handled-in-kinde-billing) | [Create plans](/billing/manage-plans/create-plans/#collect-tax-automatically) | [Connect to Stripe and set policies](/billing/get-started/connect-to-stripe/#collect-tax-automatically)
</details>
