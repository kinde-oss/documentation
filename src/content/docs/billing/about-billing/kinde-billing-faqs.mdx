...
description: "Answers on Kinde billing—Pay annually, mixed-interval plans, Stripe, trials, tax, pricing tables, and self-serve"
sidebar:
  order: 4
relatedArticles:
...
[Build a pricing table](/billing/billing-user-experience/plan-selection/#how-customers-choose-annual-pricing) | [Upgrade and downgrade methods](/billing/manage-subscribers/upgrade-downgrade-methods/)
</details>
...
[Create billing plans](/billing/manage-plans/create-plans/#offer-annual-pricing) | [The Kinde billing model](/billing/about-billing/kinde-billing-model/#billing-and-invoice-cycles)
</details>
