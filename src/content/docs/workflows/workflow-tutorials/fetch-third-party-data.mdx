...
Use the Kinde `fetch` binding to get third party data:
...
Offload sensitive or repetitive data to environment variables to avoid hardcoding them in the workflow.
...
2. Access environment variables in workflow with the helper method:
