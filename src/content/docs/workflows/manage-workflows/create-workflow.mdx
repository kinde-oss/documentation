...
featured: false
deprecated: false
ai_summary: "Guide to creating new workflows in Kinde, including connecting GitHub repositories, setting up workflow files, and configuring workflow settings."
---
