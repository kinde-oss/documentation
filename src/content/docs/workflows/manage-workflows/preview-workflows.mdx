...
You can test a workflow by testing one of your code deployments. For this you need to get the Workflow deployment ID and password from Kinde. 

## Copy testing details from Kinde

We recommend you always test your workflow code in staging environment, before you make it live.
