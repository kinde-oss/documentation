...
Workflows rely on your code being available to execute when the trigger event happens. When your update your code, you need to update the related workflow in Kinde. 
