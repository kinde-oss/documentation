...
There is a difference between deactivating or deleting a workflow. 
...
1. Go to **Workflows**.
2. Select the workflow you want to deactivate. The **Workflow** page opens.
...
There’s two parts to deleting a workflow:

### 1: Delete workflow files in your repo

The workflow in Kinde relies on your workflow files, when you delete the workflow from your repo it will remain in Kinde.  This is to safeguard your auth flow in Kinde that keeps the workflow running until you manually delete it in Kinde.

### 2: Delete a workflow in Kinde

1. Go to **Workflows**.
2. Select the … menu next to the workflow and select **Delete workflow**. A confirmation window opens explaining what is about happen.
