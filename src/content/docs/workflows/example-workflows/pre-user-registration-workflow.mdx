...
featured: false
deprecated: false
ai-summary: "Documentation for user pre-registration workflow trigger that fires after single factor authentication but before user record creation, with examples for IP checks and disposable email blocking."
---
