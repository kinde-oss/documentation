...
featured: false
deprecated: false
ai-summary: "Documentation for user post-authentication workflow trigger that fires after successful authentication, with examples for external system synchronization and security checks."
---
