...
featured: false
deprecated: false
ai_summary: "Documentation for new password provided workflow trigger that fires when users set new passwords, enabling custom validation and secure password synchronization with external systems."
---
