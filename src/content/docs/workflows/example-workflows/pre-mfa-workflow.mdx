...
featured: false
deprecated: false
ai-summary: "Documentation for pre-MFA workflow trigger that fires before multi-factor authentication, allowing custom logic like grace periods and conditional MFA enforcement."
---
