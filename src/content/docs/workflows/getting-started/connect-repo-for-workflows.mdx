...
featured: false
deprecated: false
ai-summary: "Guide to connect GitHub repository to Kinde workflows, including repo setup with kinde.json configuration, branch selection, code sync, and preview mode for safe deployments."
---
