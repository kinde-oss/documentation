...
description: Learn how to connect GitHub repository to Kinde workflows, including repo setup with kinde.json configuration, branch selection, code sync, and preview mode for safe deployments.
topics:
  - "workflows"
  - "getting-started"
  - "GitHub integration"
...
featured: false
deprecated: false
ai_summary: Guide to connect GitHub repository to Kinde workflows, including repo setup with kinde.json configuration, branch selection, code sync, and preview mode for safe deployments.
---
