...
Sign in to your Kinde account and navigate to Settings > Git. Click the "Connect GitHub" button and follow the instructions to connect your GitHub account to Kinde.
...
Navigate to Workflows in the Kinde admin area. You should see a new workflow called "Workflow 1". Select the workflow to see the details and deployments. Click on Runtime logs to view the logs for the workflow. This should currently be empty.
