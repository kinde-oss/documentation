...
description: Learn about Kinde workflow project structure including folder conventions, file naming rules, and recommendations for organizing workflow code in repositories.
topics:
  - "workflows"
  - "getting-started"
  - "project-structure"
...
featured: false
deprecated: false
ai_summary: "Guide to Kinde workflow project structure including folder conventions, file naming rules, and recommendations for organizing workflow code in repositories."
---
