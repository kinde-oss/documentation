...
The following bindings are available today, but may only be available within certain workflow contexts. You'll need to check the documentation for each workflow trigger to see which bindings are available to it.
