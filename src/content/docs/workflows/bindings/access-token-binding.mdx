...
featured: false
deprecated: false
ai-summary: "Documentation for kinde.accessToken binding that allows modification of access tokens with custom claims using setCustomClaim method and infrastructure library."
---
