...
featured: false
deprecated: false
ai-summary: "Documentation for kinde.idToken binding that allows modification of ID tokens with custom claims using setCustomClaim method and infrastructure library."
---
