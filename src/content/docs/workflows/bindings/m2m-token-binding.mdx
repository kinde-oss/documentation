...
featured: false
deprecated: false
ai-summary: "Documentation for kinde.m2mToken binding that allows modification of machine-to-machine tokens with custom claims using setCustomClaim method and infrastructure library."
---
