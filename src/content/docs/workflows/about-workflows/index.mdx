...
description: Learn about Kinde workflows - custom code execution triggered by Kinde events that allows unlimited customization of authentication flows, token generation, and external integrations using TypeScript/JavaScript.
topics:
  - "workflows"
  - "about-workflows"
  - "customization"
...
- Workflows cannot prevent or bypass Kinde's built-in verification (e.g. email verification, OTP delivery). Those steps always run as part of the auth flow.
