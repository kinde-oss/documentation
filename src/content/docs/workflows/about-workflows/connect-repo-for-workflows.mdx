...
6. If you are on an eligible plan, switch on the code preview option in ** Advanced settings**. The lets you preview code before making it live. 
...
7. Review any issues in the [Sync log](/workflows/manage-workflows/test-workflows/).
