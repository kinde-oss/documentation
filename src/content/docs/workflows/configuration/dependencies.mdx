...
description: Learn how to manage dependencies in workflow projects, including package.json configuration, supported libraries, and external library usage in Kinde workflows.
topics:
  - "workflows"
  - "configuration"
  - "dependencies"
...
featured: false
deprecated: false
ai-summary: "Documentation for managing dependencies in workflow projects, including package.json configuration and external library usage."
---
