...
You can use the properties feature to manage custom data fields and custom token properties for organiztions. Add and edit organization properties manually in Kinde, or via API.
