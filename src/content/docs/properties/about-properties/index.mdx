...
featured: false
deprecated: false
ai-summary: Overview of properties in Kinde including custom data management, token claims, property categories, and API integration for flexible data storage.
---
