...
Properties can also be used to create custom claims and to add data to M2M tokens.
...
The needs of every business is different, that’s why you can create your own properties and use them any way you want. For example, you might want to create a property to collect marketing information, identifiers from your app, or customer relationship data.
...
| Category      | Properties         | For         |
| -----------   | ------------       | ----        |
| Internal ID   | Internal app ID    | Application |
| Internal Name | Internal app name  | Application |
...
You need to [set up an M2M application to access the Kinde Management API](/developer-tools/kinde-api/connect-to-kinde-api/), and then create and edit properties using [dedicated endpoints](https://kinde.com/api/docs/#kinde-management-api-properties). 
