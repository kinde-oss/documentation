...
If you use properties to manage user data, you can edit the property values manually in Kinde or [via API](https://kinde.com/api/docs/#update-property-values-2).
...
You can also manage user properties via the [Kinde Management API](https://kinde.com/api/docs/#update-property-values-2).
