...
featured: false
deprecated: false
ai_summary: Comprehensive guide to adding and managing properties in Kinde including property types, creation, editing, and token integration considerations.
---
