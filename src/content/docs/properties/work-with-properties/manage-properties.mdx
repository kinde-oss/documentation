...
One of the powers of properties is being able to use them to include custom claims in tokens. To ensure a property can be used in tokens, make sure you switch off the **Private** option at step 6, in the procedure above.
