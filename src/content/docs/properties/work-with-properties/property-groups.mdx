...
description: "Guide to adding and managing property categories in Kinde for organizing user, organization, and application properties for better display and management"
sidebar:
  order: 3
app_context:
  - m: properties
...
featured: false
deprecated: false
ai_summary: Guide to adding and managing property categories in Kinde for organizing user, organization, and application properties for better display and management.
---
