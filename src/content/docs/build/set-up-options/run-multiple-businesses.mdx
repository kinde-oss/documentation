...
description: Guide for managing multiple businesses on Kinde including adding new businesses, switching between them, and safely deleting businesses with data export considerations.
sidebar:
  order: 4
relatedArticles:
...
featured: false
deprecated: false
ai_summary: Guide for managing multiple businesses on Kinde including adding new businesses, switching between them, and safely deleting businesses with data export considerations.
---
