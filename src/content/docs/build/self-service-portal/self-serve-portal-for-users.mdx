...
description: Guide for enabling and configuring self-service portals for users including profile management, billing access, and generating portal links with SDK and Account API examples.
sidebar:
  order: 9
tableOfContents:
  maxHeadingLevel: 3
...
featured: false
deprecated: false
ai_summary: Guide for enabling and configuring self-service portals for users including profile management, billing access, and generating portal links with SDK and Account API examples.
---
...
1. Go to **Settings > Environment > Self-serve portal**.
    ...
    ![Self-serve portal settings in Kinde](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/69070a52-77b9-447b-b7c9-8cd1f708f900/socialsharingimage)
...
![User self-management options in Kinde](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/42e3f627-1666-4121-22fb-7ce8b0820000/socialsharingimage)
...
Access to the portal is granted via a one-time link.

You can generate the portal link on the fly when a user clicks an "Account" button in your app.
...
See [Get self-serve portal link](https://docs.kinde.com/kinde-apis/frontend/#tag/self-serve-portal/get/account_api/v1/portal_link) for all the supported values.
...
![Self-serve portal as a user sees it](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/8bf8d2dd-4103-409c-3045-537f8dd9c400/socialsharingimage)
