...
- `sub_nav` – specify the portal section to open (e.g., `organization_plan_details`, `profile`).
...
```js
{
  ...
  "sub_nav": "profile" // Optional: specify the portal section to open (e.g., `organization_plan_details`, `profile`)
}
```
