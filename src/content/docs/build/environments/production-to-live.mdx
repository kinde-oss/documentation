...
<Aside type="danger" title="Do not leave these fields blank">
If you leave these fields blank at setup, Kinde’s credentials are used and rate limits will apply. It will be much more difficult to migrate once you have live users authenticating with your app.
</Aside>
...
![third party client id and client secret](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/f726c9c5-06b8-4534-93bd-862c48590600/socialsharingimage)
...
<Aside type="upgrade">
You will need a paid plan to add third-party tracking scripts. See Kinde [pricing](https://kinde.com/pricing/) for more details.
</Aside>
...
3. Scroll to the **Environment status** section and toggle the switch to **Live**.
    ...
    ![environment set live checkbox](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/c9a6e2e8-8c75-4aff-4705-949efcb87c00/socialsharingimage)
