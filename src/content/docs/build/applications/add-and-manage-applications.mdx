...
We recommend following [this specific procedure](/developer-tools/kinde-api/add-a-m2m-application-for-api-access/) for M2M applications that will access the Kinde Management API.
