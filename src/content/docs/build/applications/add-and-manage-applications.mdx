...
- [Set up authentication](https://kinde.com/docs/authentication-and-access/set-up-user-authentication/)
...
> ⚠️ Deleting an application is a destructive action which cannot be reversed. We recommend backing up all relevant data and checking for application dependencies.
