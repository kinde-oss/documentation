...
We recommend following [this specific procedure](/developer-tools/kinde-api/about-m2m-scopes/) for M2M applications that will access the Kinde Management API.
