...
To further protect your project, we recommend you [register your API](/developer-tools/kinde-api/register-an-api/) in Kinde and make sure it is enabled for your front end application.

You will then need to [request the audience](/developer-tools/kinde-api/register-an-api/#request-an-audience-be-added-to-a-token) from your front end to make sure it is included in the `access_token` when your user authenticates with Kinde.
