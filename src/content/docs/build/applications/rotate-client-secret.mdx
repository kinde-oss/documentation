...
4. If you want, opt in to rotate the client secret and retain the old secret. You may need to [upgrade plans](https://kinde.com/pricing/) to do this.
5. If you don’t want to retain the previous secret, or you don’t want to upgrade, select **Rotate client secret**. A new client secret is generated, but the previous secret is not retained.
