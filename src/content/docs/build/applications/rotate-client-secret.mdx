...
## Rotate credentials manually in Kinde

1. In Kinde, go to **Settings > Applications**.
2. Select **View details** on the relevant application.
3. Scroll to the **Admin actions** section and select **Rotate client secret**.
4. Update any dependent apps, connections, and services with the new secret.
