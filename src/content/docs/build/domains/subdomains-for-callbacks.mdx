...
For every organization that has it's own subdomain, you will add an organization handle. The handle and the subdomain need to match exactly. Here's an example.
