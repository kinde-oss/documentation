...
description: Guide for implementing organization handles and dynamic callbacks to route users to correct subdomains in multi-tenant applications with authentication flow examples.
sidebar:
  order: 3
relatedArticles:
