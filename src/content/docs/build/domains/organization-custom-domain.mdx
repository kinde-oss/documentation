...
If Chrome shows a **Dangerous site** warning on the custom domain, see [Troubleshoot Chrome ‘Dangerous site’ warning](/build/domains/pointing-your-domain/#troubleshoot-chrome-dangerous-site-warning). 
