...
4. Select the refresh icon in the top right of the custom domain panel. This triggers the SSL certificate provisioning. 
5. These are the provisioning statuses you might see:
    - Unprovisioned
    - Provisioning in progress
    - Provisioned
    - Provisioning failed
    
    Once successfully provisioned, your custom domain will then be used for this organization. You will also receive an email notification when the process is complete.
