...
description: Guide for controlling organization creation during user signup, including how to disable automatic organization creation for new registrations.
sidebar:
  order: 7
relatedArticles:
...
featured: false
deprecated: false
ai_summary: Guide for controlling organization creation during user signup, including how to disable automatic organization creation for new registrations.
---
