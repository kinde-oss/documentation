...
featured: false
deprecated: false
ai-summary: Guide for controlling organization creation during user signup, including how to disable automatic organization creation for new registrations.
---
