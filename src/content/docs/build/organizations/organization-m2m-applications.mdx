...
featured: false
deprecated: false
ai_summary: Guide for creating organization-scoped machine-to-machine applications to provide secure API access for automated systems and backend services within specific organizations.
---
