...
2. Add through the [Kinde management API](https://kinde.com/api/docs/#create-organization).
...
2. Add users via the [Kinde management API](https://kinde.com/api/docs/#add-organization-users).
...
> ⚠️ Caution: the `org_code` in the http request is vulnerable to manipulation, so only allow registrations to organizations that you would allow anyone to sign up to. If this is not the case, we suggest you leave this switched off and add the user to the right organization later via the [Kinde management API](https://kinde.com/api/docs/#kinde-management-api).
...
1. Via the [Kinde management API](https://kinde.com/api/docs/#kinde-management-api-organizations)
...
2. Via the [Kinde Management API](https://kinde.com/api/docs/#kinde-management-api-permissions)
...
2. Via the [Kinde Management API](https://kinde.com/api/docs/#kinde-management-api-feature-flags)
