...
You can also access our [starter kits on GitHub](https://github.com/kinde-starter-kits) and our [Kinde Management API library](https://kinde.com/api/docs/#kinde-management-api).
