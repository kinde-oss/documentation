...
featured: false
deprecated: false
ai-summary: Guide to using OAuth 2.0 scopes in Kinde including supported scopes, authorization flows, and implementation guidance for different application types.
---
