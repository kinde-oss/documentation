...
featured: false
deprecated: false
ai-summary: Guide for customizing Kinde tokens by adding custom claims, properties, and third-party integrations including step-by-step configuration for access, ID, and M2M tokens.
---
