...
Refresh tokens have a default lifetime of **15 days (1,296,000 seconds)**. You can change this in **Settings > Applications > [your app] > Tokens**. The refresh token lifetime must always be set longer than the access token lifetime.
