...
description: Step-by-step guide for adding, updating, and deleting environment variables in Kinde including naming conventions and sensitive variable management.
sidebar:
  order: 2
relatedArticles:
