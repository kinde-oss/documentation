...
- We recommend using UPPER_SNAKE_CASE for environment variables as this is a widely adopted convention.
- Sensitive key values are obscured for security, but they can still be copied.
- Mark variables as sensitive for credentials, API keys, and other secrets.
- Avoid including sensitive data in variable names.
