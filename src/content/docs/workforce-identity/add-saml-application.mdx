...
featured: false
deprecated: false
ai_summary: "Step-by-step guide to connecting a third-party tool as a SAML application in Kinde, with Kinde acting as the identity provider. Workforce identity is available on the Kinde Scale plan. Covers adding an application from the catalog or as a generic SAML application, entering service provider details (SP entity ID, ACS URL, Name ID format and source) or importing SP metadata, copying Kinde IdP metadata into the third-party tool, mapping Kinde fields to SP attribute names, and choosing authentication methods. Explains testing with Test SSO, showing the app tile on the self-serve portal (including enabling the Applications module), restricting access by role, setting session lifetime (default 86400 seconds, max 30 days) and SAML assertion validity (default 3600 seconds, max 24 hours), signing and encryption, configuring single logout via the SP logout callback URL, and deleting an application. Includes troubleshooting for access denied errors, empty signing certificates, rejected assertions, and missing portal tiles. Intended for developers and admins."
---
...
2. Select **Add application**.
    ...
    ![Add application button on the Workforce identity tab in Kinde](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/11f3548f-1775-4cff-d3d0-0da39498e900/socialsharingimage)
...
4. Kinde creates the application and opens its **Details** page.
    ...
    ![Details page for a SAML application in Kinde](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/c16bc85a-15ff-48ec-46f5-45a40fb7a400/socialsharingimage)
...
2. Select **Import SP metadata** if your tool publishes a metadata file. Supply the metadata URL or XML. Kinde fills in the entity ID, ACS URL, and certificates for you, saving you time. Select **Save** to apply the settings.
    ...
    ![Import SP metadata button in Kinde](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/209e3a41-d4d8-41cf-0116-059317a65700/socialsharingimage)
...
1. Go to the **Kinde IdP metadata** tab and copy the **IdP metadata URL**. If your tool supports auto-configuration, use this URL to import all of Kinde's details at once.
    ...
    ![Kinde IdP metadata tab for a SAML application](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/dff69d99-bfd9-4895-b7f5-1d51f464cc00/socialsharingimage)
...
1. Go to the **Attribute mapping** page.
    ...
    ![Attribute mapping tab for a SAML application in Kinde](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/d31e1b0e-82dd-4c08-3893-56da56035900/socialsharingimage)
...
2. Scroll to the end of the page. Under **Test this connection**, select **Test SSO**.
    ...
    ![Test SSO option on the Kinde IdP metadata tab](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/33eb4c6b-de81-4024-dd76-38e3c5a59800/socialsharingimage)
...
2. Turn on **Show on self-serve portal**.
    ...
    ![Show on self-serve portal setting in Kinde](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/f6c2df48-f9df-4c28-0091-4cadd2948b00/socialsharingimage)
...
6. Under **User self-management**, turn on the **Applications** toggle.
    ...
    ![Applications toggle in Kinde self-serve portal settings](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/f5d46709-afce-4ed2-adaf-b6e5696a3200/socialsharingimage)

7. Select **Save**.

The tile appears in the self-serve portal when the user signs in.

![Application tile in the Kinde self-serve portal](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/270f2ba4-af22-4712-7221-d06e785cd600/socialsharingimage)
...
3. Select the **Allowed roles**. Only organization members holding one of these roles can sign in.
    ...
    ![Role-based access control settings for a SAML application in Kinde](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/4062bcd1-d9eb-4b27-90c9-9b7659e1cf00/socialsharingimage)
...
![Sessions tab for a SAML application in Kinde](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/07325204-07fe-4ae9-d256-a73a71dc4e00/socialsharingimage)
...
2. Scroll down to the end of the **Security** section, and turn on **Force re-authentication**.
    ...
    ![Force re-authentication setting in Kinde](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/d45dcca7-5e40-4654-8d37-4d9d3a7c4d00/socialsharingimage)
...
<Aside type="warning" title="Set an explicit callback URL where you can">
