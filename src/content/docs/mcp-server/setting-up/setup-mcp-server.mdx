...
- **Start exploring** — Simply ask your AI assistant "What tools do you have available from Kinde?" and watch it list all the operations you can perform with natural language
- **Try it out** — Test the power of natural language with the example prompts in the [Testing the MCP Server](#step-3-testing-the-mcp-server) section. Ask questions like "Show me all users" or "Create a new role called moderator" and see how easy it is
- **Discover capabilities** — Review the [About the Kinde MCP Server](/mcp-server/about-mcp-server/about-mcp-server/) documentation to see everything you can accomplish with simple commands
- **Fine-tune your setup** — Ensure your API key has the appropriate scopes for the operations you need. See [API Scopes and Permissions](https://docs.kinde.com/kinde-apis/management/#scopes) for details
