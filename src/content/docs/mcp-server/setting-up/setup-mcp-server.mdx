...
An **Environment API Key** is a global authentication key in Kinde that enables you to access your Kinde Users, Organizations, Roles, Permissions, and more programmatically, such as the Kinde Management API, or the Kinde MCP Server.
...
Now that you have your API key, configure your AI assistant to connect to the Kinde MCP Server using your API key and Kinde subdomain:
...
<details>
<summary>Why are some expected operations missing?</summary>

If you're not seeing all the operations you expect, remember that:
