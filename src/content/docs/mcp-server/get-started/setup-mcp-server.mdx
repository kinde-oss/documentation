...
description: "Learn how to set up the Kinde MCP Server with AI assistants like Cursor, Claude Desktop, Claude CLI, and VS Code to manage users, organizations, roles, and permissions directly from your IDE using natural language"
sidebar:
  order: 1
tableOfContents:
  maxHeadingLevel: 3
...
Claude CLI (Claude Code) uses command-based MCP setup rather than editing `claude_desktop_config.json`.
