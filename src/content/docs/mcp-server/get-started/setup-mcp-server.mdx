...
7. Select the scopes you want to grant:
    ...
    See all the available [scopes you can use in the Kinde MCP Server](/mcp-server/about-mcp-server#available-operations-and-scopes)
...
Check out the [Kinde MCP Server about page](/mcp-server/about-mcp-server) for more information on the available operations.
