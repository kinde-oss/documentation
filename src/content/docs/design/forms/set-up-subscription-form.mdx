...
## Check subscribers are human

You can add an extra layer of security to the subscription form by adding a [Coudflare Turnstile](https://www.cloudflare.com/en-gb/products/turnstile/) widget to prevent robots trying to sign up. See [Add robot detection to your subscription page](https://kinde.com/docs/customize/robot-detection/).
