...
description: "Guide for updating authentication page content including multi-language support, text variables, and escape route URL configuration for error handling."
sidebar:
  order: 2
relatedArticles:
...
featured: false
deprecated: false
ai-summary: Guide for updating authentication page content including multi-language support, text variables, and escape route URL configuration for error handling.
---
