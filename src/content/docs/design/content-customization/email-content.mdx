...
<Aside>
This limit applies to core auth email templates only. It is separate from [customizing hosted pages with code](/design/customize-with-code/customize-with-css-html/), where you can bring your own HTML, CSS, and JavaScript for Kinde-hosted UI (such as sign-in and password entry screens).
</Aside>