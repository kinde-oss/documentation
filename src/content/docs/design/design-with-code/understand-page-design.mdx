...
The 'page' is the whole user interface rendered by the browser, enabling you to provide your own markup for everything that surrounds the Kinde widget. There's also a handy placeholder so you can tell us where you want the widget rendered.
