...
For your custom styles to apply correctly, make sure they load **after** the Kinde-required CSS. See [Including the Kinde required CSS](/design/design-with-code/design-with-css/).

</Aside>

## Available style hooks

Nearly all elements in the widget have a style hook applied, allowing you to style it as needed. The best way to see which hooks are available is by using [DevTools](/design/design-with-code/inspect-design-devtools/).
