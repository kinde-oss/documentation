...
Your directory structure should be in the format `pages/(kinde)/(<route>)/page.[ts/tsx]` where `<route>` is used to map your code to a rendered page in Kinde. For example `pages/(kinde)/(register)/page.tsx` will map to the register / sign up page in the auth flow. For more information see [How page customization works](/design/design-with-code/page-customization/)
