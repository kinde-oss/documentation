...
description: "Guide for adding marketing consent checkboxes to sign-up pages including feature configuration, label customization, and user consent status management."
sidebar:
  order: 6
relatedArticles:
...
featured: false
deprecated: false
ai_summary: Guide for adding marketing consent checkboxes to sign-up pages including feature configuration, label customization, and user consent status management.
---
