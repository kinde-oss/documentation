...
description: "Guide for managing page layouts including authentication pages, background customization, widget positioning, and additional auth element configuration."
sidebar:
  order: 1
relatedArticles:
...
featured: false
deprecated: false
ai_summary: Guide for managing page layouts including authentication pages, background customization, widget positioning, and additional auth element configuration.
---
