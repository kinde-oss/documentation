...
- view [settings](/design/customize-with-code/design-with-css/) applied to a component or layout, especially when they aren’t defined under `:root`.
- get the [style hook](/design/customize-with-code/design-with-style-hooks/) of an element.
