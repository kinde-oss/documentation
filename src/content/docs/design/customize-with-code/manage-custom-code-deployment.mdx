...
featured: false
deprecated: false
ai_summary: Guide for managing custom code deployments including code preview, syncing, making deployments live, and rollback functionality for Plus and Scale plan users.
---
