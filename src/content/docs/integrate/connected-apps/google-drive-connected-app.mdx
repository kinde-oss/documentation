...
featured: false
deprecated: false
ai-summary: Comprehensive guide to setting up Google Drive as a connected app in Kinde including Google Cloud Console configuration, OAuth setup, and API enablement.
---
...
<img
  ...
  alt="Creating 0Auth client in Google Cloud"
  width="672px"
  height="auto"
  fetchpriority="low"
  loading="lazy"
