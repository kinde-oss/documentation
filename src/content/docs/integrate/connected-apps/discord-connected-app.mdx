...
Before you can add Discord as a connected app in Kinde, you need to [set up a machine to machine application](/developer-tools/kinde-api/add-a-m2m-application-for-api-access/) to connect to Kinde’s API.
...
3. Give your application a name and agree to Discord’s terms, then select **Create**.
    ...
    ![screen shot of discord add application screen](https://imagedelivery.net/skPPZTHzSlcslvHjesZQcQ/d2575a88-d638-43de-1f75-b2fb7f542a00/public)
    
4. Copy your **Application ID** and **Public Key**. These correspond to the Client ID and Client secret in your Kinde M2M application.
...
6. In the **Redirects** field, select **Add redirect**.
