...
Before you can add GitHub as a connected app in Kinde, you need [set up a machine to machine application](/developer-tools/kinde-api/add-a-m2m-application-for-api-access/) for connecting to the Kinde API.
