...
Before you can add GitHub as a connected app in Kinde, you need [set up a machine to machine application](/developer-tools/kinde-api/about-m2m-scopes/) for connecting to the Kinde API.
