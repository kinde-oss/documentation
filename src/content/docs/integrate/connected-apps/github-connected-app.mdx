---
page_id: 894f9c6a-4929-4b99-aac3-7aaeb0a469a6
title: GitHub connected app
description: Step-by-step guide to setting up GitHub as a connected app in Kinde including OAuth app creation, permissions configuration, and callback URL setup
sidebar:
  order: 3
relatedArticles:
...
featured: false
deprecated: false
ai_summary: Step-by-step guide to setting up GitHub as a connected app in Kinde including OAuth app creation, permissions configuration, and callback URL setup.
---
