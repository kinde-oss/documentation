...
This is Step 2 of [Add a connected app to Kinde](https://docs.kinde.com/integrate/connected-apps/add-connected-apps/#step-1-add-the-connected-app-in-kinde).
...
See [Step 3: Configure the connected app in Kinde](https://docs.kinde.com/integrate/connected-apps/add-connected-apps/#step-3-configure-the-connected-app-in-kinde).
