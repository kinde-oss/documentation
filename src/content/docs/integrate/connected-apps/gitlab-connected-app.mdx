...
featured: false
deprecated: false
ai-summary: Guide to setting up GitLab as a connected app in Kinde including OAuth provider configuration, scope selection, and application credentials setup.
---
