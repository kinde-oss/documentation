...
description: Guide to setting up GitLab as a connected app in Kinde including OAuth provider configuration, scope selection, and application credentials setup
sidebar:
  order: 4
relatedArticles:
...
featured: false
deprecated: false
ai_summary: Guide to setting up GitLab as a connected app in Kinde including OAuth provider configuration, scope selection, and application credentials setup.
---
