...
<Tabs>
  <TabItem label="Cloudflare Worker JWT">
...
3. Replace `https://<your_kinde_account>.kinde.com/.well-known/jwks` with your Kinde account’s JWKS URL. For example: `https://tamalkinde.kinde.com/.well-known/jwks`
