...
description: Guide to configuring Kinde with Resend for custom SMTP email delivery including API key setup, domain verification, and SMTP configuration
sidebar:
  order: 12
relatedArticles:
...
featured: false
deprecated: false
ai_summary: Guide to configuring Kinde with Resend for custom SMTP email delivery including API key setup, domain verification, and SMTP configuration.
---
...
1. In Kinde, go to **Settings > Environment > Messaging > Email Sender**.
