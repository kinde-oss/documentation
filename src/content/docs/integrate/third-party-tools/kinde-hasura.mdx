...
- A [Hasura cloud](http://cloud.hasura.io/) account (Sign up for free)
...
2. Select a **region** closest to your application, and select **Create Free Project**.
3. Select the pencil icon next to your project name to rename your project (optional).
4. Select **Env vars** tab, and select **New Env Var.** A side panel opens.
