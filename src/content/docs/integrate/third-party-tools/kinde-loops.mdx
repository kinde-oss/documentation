...
1. Sign in to your Loops account and go to [**Settings > API**](https://app.loops.so/settings?page=api)
...
You can import all your Kinde users to Loops using the Kinde's export user feature. Follow the steps: 
...
7. Create a new `.csv` file with the following columns: `First Name`, `Last Name`, `Email`, `User Group`. Copy the Kinde contacts to this `.csv` file
