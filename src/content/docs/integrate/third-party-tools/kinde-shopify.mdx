...
2. Enter **Discovery URL**:
   ...
   ```
    <Aside>
    Replace `<YOUR_DOMAIN>` with your [custom domain](/build/domains/pointing-your-domain/) (e.g., `https://auth.yourbusiness.com`) or Kinde domain (e.g., `https://your_business.kinde.com`)
    </Aside>
