...
When deploying Nuxt applications to Vercel with edge functions, follow Vercel's [Nuxt on Vercel guide](https://vercel.com/docs/frameworks/full-stack/nuxt) and use Kinde's server-side authentication patterns.
