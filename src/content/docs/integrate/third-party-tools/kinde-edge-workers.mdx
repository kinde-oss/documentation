...
When deploying Nuxt applications to Vercel with edge functions, follow Vercel's [Nuxt edge functions documentation](https://vercel.com/docs/functions/runtimes/edge?framework=other) and use Kinde's server-side authentication patterns.
