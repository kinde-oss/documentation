...
description: "Discover how to integrate Kinde authentication seamlessly into a Next.js application while managing user data with a Drizzle-powered SQLite database."
sidebar:
  order: 11
relatedArticles:
