...
Rely on the `user_id` for authorization and auditing within your API. If you need organization context, consider using [organization-level API keys](/api-keys/about-api-keys/api-keys-for-organizations/) instead.
