...
If you're not using a Kinde SDK, call the Account API endpoint and pass `subnav` to deep link to API Keys. See [Get self-serve portal link](https://docs.kinde.com/kinde-apis/frontend/#tag/self-serve-portal/get/account_api/v1/portal_link) for supported values.
