...
If you’ve enabled the self‑serve portal, customers can rotate their keys themselves using the built‑in **Rotate key** option. You can also deep link to the API Keys page. See: [/manage-your-apis/add-manage-api-keys/self-serve-api-keys/].
