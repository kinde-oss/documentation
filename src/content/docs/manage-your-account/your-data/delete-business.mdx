...
Only owners of a businesses on a free plan can self-serve delete. All businesses on paid plans need to contact Kinde support.
...
If you want to re-use the Kinde domain issued to the business, we recommend not deleting your business. Instead, consider using a [custom domain](/build/domains/pointing-your-domain).

</Aside>

## Before you delete a business

Make sure you [export your data](/manage-your-account/your-data/exporting-data/) before you delete. You may also want to let team members know they will no longer be able to access the business.
