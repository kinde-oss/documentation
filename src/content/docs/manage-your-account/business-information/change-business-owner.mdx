...
app_context:
  - m: settings
description: Find out how to change the Owner of a business in Kinde.
topics:
  - manage-your-account
...
featured: false
deprecated: false
ai_summary: Find out how to change the Owner of a business in Kinde.
---

The business Owner in Kinde has full power in the business, including setting any role for any member, and being able to assign the role of 'Owner' to others. You might need to change who the owner of a business is to reflect a new org structure or when someone leaves. [Read more about the roles in a Kinde business and how to assign them to members](/get-started/team-and-account/add-team-members/).
