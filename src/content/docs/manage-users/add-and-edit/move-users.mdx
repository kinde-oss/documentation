...
- User details and passwords need to be in NDJSON (Newline Delimited JSON) format, with a file size of 49MB or less.
- If you’ve got large user sets (over 49MB) or are concerned about file size limits, you might consider importing in batches.
