...
Kinde supports migrating the following authentication methods from Auth0: Usernames, Email, Phone, Google, Apple, Microsoft, Facebook, Github, Twitch, Bitbucket
If you need to migrate another authentication type from Auth0 please get in touch with support. 
