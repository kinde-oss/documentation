...
Kinde allows you to design the page where customers can go to subscribe to your newsletter or other product updates. See [Set up a subscription form](/design/forms/set-up-subscription-form/).
