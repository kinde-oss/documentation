...
app_context:
  - m: user
    s: identities
description: Guide to adding and managing user identities in Kinde including email addresses, phone numbers, and social login connections for multi-identity support.
sdk: []
languages: []
audience:
  - admins
