---
page_id: 1affd3cc-848a-451d-b2ba-18917d582fd2
title: Audit log
sidebar:
  order: 2
relatedArticles:
...
app_context:
  ...
  - m: user
    s: activity
description: Guide to viewing individual user activity logs including activity history, sign-in methods, and detailed activity monitoring in Kinde.
topics:
  - manage-users
  - view-activity
sdk: []
...
featured: false
deprecated: false
ai_summary: Guide to viewing individual user activity logs including activity history, sign-in methods, and detailed activity monitoring in Kinde.
---
...
2. In the left menu, select **Activity**. A summary of the user’s activity shows at the top of the page.
