---
description: >
  Guide to requiring explicit policy acceptance during user signup including terms of use, privacy policy, and acceptance tracking for compliance.
page_id: 14fa89c4-59d3-4a7e-978a-6d3a4f23f2c1
title: Require users to accept policies at sign up
sidebar:
  order: 4
relatedArticles:
