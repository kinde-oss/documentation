...
app_context:
  ...
  - m: user
    s: roles
description: Comprehensive guide to managing user roles in Kinde including role creation, editing, deletion, API integration, and token customization for access control.
topics:
  - manage-users
...
featured: false
deprecated: false
ai-summary: Comprehensive guide to managing user roles in Kinde including role creation, editing, deletion, API integration, and token customization for access control.
---
