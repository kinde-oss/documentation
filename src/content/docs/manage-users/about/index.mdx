---
description: >
  Overview of user management in Kinde including organizations, user profiles, identities, permissions, roles, and options for adding users to your application.
...
featured: false
deprecated: false
ai-summary: Overview of user management in Kinde including organizations, user profiles, identities, permissions, roles, and options for adding users to your application.
---
