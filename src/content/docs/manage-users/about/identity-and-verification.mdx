...
# Identity and user verification in Kinde
...
You can update identities by adding a new identity and deleting the old one. See [Add and manage user identities](manage-users/about/add-manage-user-identities/), or [via the Kinde API](https://kinde.com/api/docs/#kinde-management-api).
