...
featured: false
deprecated: false
ai_summary: Overview of machine-to-machine applications in Kinde including OAuth 2.0 client credentials flow, use cases, types, and best practices for secure API authentication.
---
