...
Here’s some short answers to the most common M2M questions. Click on any question to expand the answer.
...
[About machine-to-machine applications](https://docs.kinde.com/machine-to-machine-applications/about-m2m-applications/)
...
[Create machine-to-machine application](https://docs.kinde.com/machine-to-machine-applications/create-m2m-application/)
...
[Machine-to-machine security guide](https://docs.kinde.com/machine-to-machine-applications/about-m2m-applications/)
...
[Add APIs to machine-to-machine applications](https://docs.kinde.com/machine-to-machine-applications/add-m2m-api/)
...
[Machine-to-machine API reference](https://docs.kinde.com/machine-to-machine-applications/m2m-api-reference/)
...
[Management API integration](https://docs.kinde.com/developer-tools/kinde-management-api/about-management-api/)
...
[Management API overview](https://docs.kinde.com/developer-tools/kinde-management-api/about-management-api/)
