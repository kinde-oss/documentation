...
featured: false
deprecated: false
ai_summary: Guide to organization-scoped M2M applications including tenant isolation, token structure with org_code claims, and best practices for multi-tenant environments.
---
