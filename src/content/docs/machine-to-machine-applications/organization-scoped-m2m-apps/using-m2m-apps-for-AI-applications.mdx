...
description: Guide to using M2M applications for AI tools and agents including organization-scoped authentication, custom properties, feature flags, and best practices for AI service security
sidebar:
  order: 3
relatedArticles:
...
featured: false
deprecated: false
ai-summary: Guide to using M2M applications for AI tools and agents including organization-scoped authentication, custom properties, feature flags, and best practices for AI service security.
---
