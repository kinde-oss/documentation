...
featured: false
deprecated: false
ai_summary: Guide to adding metadata to M2M applications using properties including property definition, assignment, and token customization for configuration management.
---
