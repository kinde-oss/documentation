...
description: Overview of M2M application API scopes for controlling token permissions and access control in Kinde applications
sidebar:
  order: 2
relatedArticles:
...
featured: false
deprecated: false
ai_summary: Overview of M2M application API scopes for controlling token permissions and access control in Kinde applications.
---
