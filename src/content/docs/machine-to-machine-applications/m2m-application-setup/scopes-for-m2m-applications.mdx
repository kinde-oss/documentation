...
To learn how to create custom scopes and assign them to APIs and applications, see: [Custom API scopes in Kinde](https://docs.kinde.com/developer-tools/your-apis/custom-api-scopes/)
